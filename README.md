...
If trials need to be manually excluded use step 3 processing_for_pausing

summary stats uses final outputs to give included trial information. 

Step 1: Pivots

Inputs iCatcher .txt file, Datavyu frame .csv, and Lookit frame .csv. Pivots information to determine looking times left, right, or away.
